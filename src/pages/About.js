    ...
    <section id="about" className="about-container">
      <div className="about-content">
        ...
        <div className="about-text-container">
          <h2><b>About Me</b></h2>
          <p>
            <b>Hi! I'm Aman Raj, a passionate frontend developer and AI/ML enthusiast.
            ...
            seamless user experiences with creative CSS and cutting-edge development techniques.</b>
          </p>
        </div>
